...
; Java/trace method: java.lang.Boolean.logicalOr#bool#bool
; Receiver kind: object
; Argument types: ['boolean', 'boolean']
; Return type: boolean
; Symbolic paths: 1
; WARNING: logicalOr#bool#bool: INT_TO_STR treated as a no-op (Java conversion/case semantics are solver-specific)
(define-fun stub_logicalOr_bool_bool_pre ((pre Heap) (receiver Int) (arg0 Bool) (arg1 Bool)) Bool
  (and (<= 0 receiver) (= (select (heap-kind pre) receiver) K_OBJECT) ((_ is JBool) (select (heap-object-value pre) receiver))))
(define-fun stub_logicalOr_bool_bool ((pre Heap) (receiver Int) (arg0 Bool) (arg1 Bool)) StubResult
  (ite (and (<= 0 receiver) (= (select (heap-kind pre) receiver) K_OBJECT) ((_ is JBool) (select (heap-object-value pre) receiver))) (mk-result (mk-heap (heap-kind pre) (heap-object-value pre) (heap-list-size pre) (heap-list-data pre) (heap-map-size pre) (heap-map-present pre) (heap-map-data pre) (heap-set-size pre) (heap-set-present pre)) OUT_NORMAL (JBool (or arg0 arg1)) EX_NONE) (mk-result pre OUT_THROWN JNull EX_INVALID_RECEIVER)))
